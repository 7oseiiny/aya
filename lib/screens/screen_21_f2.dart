    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            button_(onpressed: (){  Navigator.pop(context);}, background_color: Color(0xfff1f1f1), font_color: Colors.black, text: "الغاء",font_size: 20,height: 38,width: 160,),
            button_(onpressed: (){  Navigator.pop(context);}, background_color: Color(0xff303b7d), font_color: Colors.white, text: "استكمال",font_size: 20,height: 38,width: 160,),
          ],
        )
